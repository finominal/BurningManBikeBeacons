...
//control
const int totalPixels = 51;
const int numPixels = 51;

//Adafruit_WS2801 strip = Adafruit_WS2801(numPixels, 6, 7);
Adafruit_NeoPixel strip = Adafruit_NeoPixel(numPixels, 1, NEO_GRB + NEO_KHZ800);
...
volatile const int  encoderPinA = 3;   // right
volatile const int  encoderPinB = 4;   // left
volatile const int  encoderButton = 5;    // depress encoder 
...
void InitializeBalls()
{
  ...
  ball one =   {pink,stickHeight,0,numPixels-1,numPixels-1,0,true,6,0  ,-0.93,millis()-20,millis()};
  //delay(50);  
  ball two = {aqua,stickHeight,0,numPixels-1,numPixels-1,0,true,6,1500,-0.94,millis()-20,millis()};
  //delay(50); 
  ball three =  {yellow,stickHeight,0,numPixels-1,numPixels-1,0,true,6,2000,-0.95,millis()-20,millis()};
  //delay(50);
